...
namespace Workflow.Extensions
{
    public static class WorkflowInstanceExtensions
    {
        ...
        {
            string result = $"<b>Workflow history</b><br/><br/>{instance.WorkflowType.Description(instance.ScheduledDate)} requested by {instance.AuthorUser.Name} on {instance.CreatedDate:dd MMMM yyyy}<br/>";
